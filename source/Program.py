...
class Program:
    ...
    def main(self, args):
        ...
        if(args.arbol):
            err_t, err_v = self.create_random_forest(
                args.umbral_poda, test_size)
            ...
            err_t, err_v = self.process_neural_network(
                layers, neurons_hidden_layer, activation_func, output_activation_func, test_size, epochs)
            prediction_path = DATASETS_DIRECTORY + \
    ...
    def create_random_forest(self, prune_gain, test_size):
        ...
        cvm = CrossValidationManager(
            random_forest, X_train, y_train, l0_1_loss)
    ...
    def process_neural_network(self, layers, neurons_hidden_layer,
        ...
        cvm = CrossValidationManager(
            neural_network, X_train, y_train, l0_1_loss)
