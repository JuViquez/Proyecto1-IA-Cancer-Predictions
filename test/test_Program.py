...
def test_main_neural_network():
    ...
    p.process_neural_network.assert_called_with(args.numero_capas, args.unidades_por_capa,
                             args.funcion_activacion, args.funcion_activacion_salida,
                             args.porcentaje_pruebas, args.iteraciones_optimizador)
...
def test_main_random_forest():
    ...
    p.create_random_forest.assert_called_with(args.umbral_poda, args.porcentaje_pruebas)
